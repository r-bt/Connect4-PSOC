...
// Adapted from pitches.h from Arduino
#define NOTE_B0  31
#define NOTE_C1  33
#define NOTE_CS1 35
#define NOTE_D1  37
...
int win_sound_effect[] = {
    NOTE_E6,5,NOTE_G6,5,NOTE_E7,5,NOTE_C7,5,NOTE_D7,5,NOTE_G7,5
};

int piece_played_effect[] = {
    NOTE_G4,4,NOTE_G5,4,NOTE_G6,4
};

int lose_sound_effect[] = {
    NOTE_B4,15,NOTE_C4,15,NOTE_D4,30,NOTE_G4,80
};
